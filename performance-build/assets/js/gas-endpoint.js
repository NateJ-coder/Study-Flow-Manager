...
(function () {
  ...
  const CALENDAR_URL = 'https://script.google.com/macros/s/AKfycbwDnClA4AKpSc_G_SVA0rVVZnfPpukMGFuLIDPBEGFkqoqpiLrpIJaK3E4i0FZKIkyWAA/exec';
  ...
  window.SF_GAS = {
    CALENDAR_URL,
    SHARED_KEY,
  version: '2025-10-16-11' // bump when you change the URL/key
  };
